...
microbes = Microbe.create([
  ...
  { name: 'Bacillus subtilis', tag: 'mbbacs', description: "<p>Used as a probiotic, to treat used to treat asthma, cancer, depression,leprosy, psoriasis, dermatitis, eczema and tuberculosis. Found both in the human gut, and in soil! </p><p>It needs a place that: </p><ul><li>has harsh conditions</li><li>is fairly hot</li><li>cures what ails you</li></ul>" }
])
